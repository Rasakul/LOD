...
\subsubsection{General statistically evaluation}
...
{\scalebox{0.3}{\includegraphics{screenshot_ub_tu.PNG}}}
\subfigure[Extended search]
{\scalebox{0.3}{\includegraphics{screenshot_ub_tu_extended_search.PNG}}}
...
\centering
	\begin{tikzpicture}
		\begin{axis}		
			...
			\addplot table[x=Question, y=Number] {data_ld_library_useful.csv};
		\end{axis}
	\end{tikzpicture}
		\begin{tikzpicture}
		\begin{axis}		
			...
			\addplot table[x=Answer, y=Imagine] {data_ld_library_use.csv};
			\addplot table[x=Answer, y=Use] {data_ld_library_use.csv};
...
\begin{figure}[!htbp]
\centering
{\scalebox{0.3}{\includegraphics{screenshot_pub_database.PNG}}}
...
\centering
	\begin{tikzpicture}
		\begin{axis}		
			...
			% Ausgabe der x Werte ohne Tausendermarkierung@
			x tick label style={/pgf/number format/1000 sep=}]
			\addplot table[x=Question, y=Number] {data_publication_useful.csv};
		\end{axis}
	\end{tikzpicture}
		\begin{tikzpicture}
		\begin{axis}		
			...
			x tick label style={/pgf/number format/1000 sep=},
			legend pos=north west]
			\addplot table[x=Answer, y=Imagine] {data_publication_use.csv};
			\addplot table[x=Answer, y=Use] {data_publication_use.csv};
			\legend{Can imagine, Would use}
		\end{axis}
	\end{tikzpicture}
